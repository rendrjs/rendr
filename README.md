...
- ``errorHandler`` *Optional* Callback for [Express.js errors](http://expressjs.com/guide/error-handling.html).

   **Example** ``function (err, req, res, next) { }``


- ``notFoundHandler`` *Optional* - Callback for [Express.js not found errors](http://expressjs.com/guide/error-handling.html)
